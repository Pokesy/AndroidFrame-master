...
public class DgnsjDetailActivity extends BasicTitleBarActivity {
    ...
    private void init() {
        ...
        ivBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                View view = DgnsjDetailActivity.this.getLayoutInflater().inflate(R.layout.test, null);
                ...
                final EasyDialog dialog = new EasyDialog(DgnsjDetailActivity.this);
//                        .setLayoutResourceId(R.layout.test)//layout resource id
                dialog.setLayout(view)
                        .setBackgroundColor(DgnsjDetailActivity.this.getResources().getColor(R.color.background_color_black))
                        ...
                        .setMatchParent(true)
                        .setOutsideColor(DgnsjDetailActivity.this.getResources().getColor(R.color.font_color_black_half))
                        .show();
                bt.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
