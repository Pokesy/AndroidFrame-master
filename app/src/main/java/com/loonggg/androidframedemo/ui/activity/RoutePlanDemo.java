...
import com.loonggg.androidframedemo.adapter.RouteLineAdapter;
import com.loonggg.androidframedemo.ui.basic.BasicTitleBarActivity;
import com.loonggg.androidframedemo.ui.overlayutil.BikingRouteOverlay;
import com.loonggg.androidframedemo.ui.overlayutil.DrivingRouteOverlay;
import com.loonggg.androidframedemo.ui.overlayutil.MassTransitRouteOverlay;
import com.loonggg.androidframedemo.ui.overlayutil.OverlayManager;
import com.loonggg.androidframedemo.ui.overlayutil.TransitRouteOverlay;
import com.loonggg.androidframedemo.ui.overlayutil.WalkingRouteOverlay;
 ...
 * 同时展示如何进行节点浏览并弹出泡泡
 */
public class RoutePlanDemo extends BasicTitleBarActivity implements BaiduMap.OnMapClickListener, SensorEventListener,
    ...
    @Bind(R.id.customicon1)
    RadioButton customicon1;
    @Bind(R.id.pre)
    Button pre;
    @Bind(R.id.next)
    Button next;
