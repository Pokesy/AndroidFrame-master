 ...
 */
public class SgalAdapter extends BaseJAdapter<RecyclerHolder,String> {
    ...
    public SgalAdapter(Context context, List<String> s) {
        super(context);
...
//
            ...
            return new NewsHolder(layoutInflater.inflate(R.layout.fragment_vedio_item, viewGroup, false));
        }
    }
