...
public class AnswerAdapter extends TeachBaseAdapter<AnswerModel> implements View.OnClickListener {

    private Context context;

    public AnswerAdapter(Context context, List<AnswerModel> data, int layoutResId) {
        super(context, data, layoutResId);
        this.context=context;
    }

    @Override
    protected void bindData(ViewHolder holder, AnswerModel item, int position) {
