 ...
 */
public class PeopleAdapter extends RecyclerSwipeAdapter<String> {
    // 数据集
    private List<String> mDataset;
    Context context;
    protected LayoutInflater mLayoutInflater;

    public PeopleAdapter(Context context, List<String> s) {
        super(context);
...
//        recyclerHolder.getView(R.id.relativelayout).setBackgroundColor(Color.TRANSPARENT);
    ...
    protected View createView(LayoutInflater layoutInflater, ViewGroup viewGroup, int viewType) {
        return layoutInflater.inflate(R.layout.fragment_people_item, viewGroup, false);
    }
