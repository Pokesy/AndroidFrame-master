 ...
 */
public class EsAdapter extends BaseJAdapter<RecyclerHolder,String> {
    ...
    public EsAdapter(Context context, List<String> s) {
        super(context);
...
//
            ...
            return new NewsHolder(layoutInflater.inflate(R.layout.activity_es_item, viewGroup, false));
        }
    }
