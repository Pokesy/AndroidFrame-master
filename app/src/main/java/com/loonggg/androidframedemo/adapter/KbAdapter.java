 ...
 */
public class KbAdapter extends BaseJAdapter<RecyclerHolder,String> {
    ...
    public KbAdapter(Context context, List<String> s) {
        super(context);
...
//        } else {
//            return new NewsHolder(layoutInflater.inflate(R.layout.activity_kb_item, viewGroup, false));
//        }
        return new NewsHolder(layoutInflater.inflate(R.layout.activity_kb_item, viewGroup, false));
    }
